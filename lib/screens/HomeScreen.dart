                        ...
                        children: [
                          GestureDetector(
                            ...
                            child: FirstNewsCardHorizontal(
                              title: news.title,
                              mediumImageTitleUrl: news.mediumImageTitleUrl,
                            ),
                          ),
                            ...
                            child: Row(
                              children: [
                                ...
                                ElevatedButton(
                                  ...
                                  child: const Text(Strings.catBarAllNews),
                                ),
                                const SizedBox(
                                  width: 5,
                                ),
                                ElevatedButton(
                                  ...
                                  style: ElevatedButton.styleFrom(
                                      ...
                                      textStyle: const TextStyle(
                                          ...
                                          fontFamily: "montserrat",
                                          fontWeight: FontWeight.w600)),
                                  child: const Text(Strings.catBarPopular),
                                ),
                                const SizedBox(
                                  width: 5,
                                ),
                                ElevatedButton(
                                  ...
                                  style: ElevatedButton.styleFrom(
                                      ...
                                      textStyle: const TextStyle(
                                          ...
                                          fontFamily: "montserrat",
                                          fontWeight: FontWeight.w600)),
                                  child: const Text(Strings.catBarRead),
                                ),
                                const SizedBox(
                                  width: 5,
                                ),
                                ChoiceChip(
                                  ...
                                  onSelected: (newsState) {
                                    setState(() {
                                      if(isSport) if (_filterRubricId.length >= 5) return;
                                      isSport = newsState;
                                ...
                                ChoiceChip(
                                  ...
                                  label: Text("Политика",
                                      style: TextStyle(
                                        color: isPolitics ? Colors.white : Colors.black,
                                          fontSize: 17,
                                          fontFamily: "montserrat",
                                          fontWeight: FontWeight.w600)),
                                  backgroundColor: AppColors.secondary,
                                  ...
                                  onSelected: (newsState) {
                                    setState(() {
                                      if(isPolitics) if (_filterRubricId.length >= 5) return;
                                      isPolitics = newsState;

                                      filterRubrics(isPolitics, 1);
                                    });
                                  },
                                ),
                                const SizedBox(
                                ...
                                ChoiceChip(
                                  ...
                                  label: Text("В мире",
                                      style: TextStyle(
                                        color: isInWorld ? Colors.white : Colors.black,
                                          fontSize: 17,
                                          fontFamily: "montserrat",
                                          fontWeight: FontWeight.w600)),
                                  backgroundColor: AppColors.secondary,
                                  ...
                                  onSelected: (newsState) {
                                    setState(() {
                                      if(isInWorld) if (_filterRubricId.length >= 5) return;
                                      isInWorld = newsState;
                                ...
                                ChoiceChip(
                                  ...
                                  label: Text("Культура",
                                      style: TextStyle(
                                        color: isCulture ? Colors.white : Colors.black,
                                          fontSize: 17,
                                          fontFamily: "montserrat",
                                          fontWeight: FontWeight.w600)),
                                  backgroundColor: AppColors.secondary,
                                  ...
                                  onSelected: (newsState) {
                                    setState(() {
                                      if(isCulture) if (_filterRubricId.length >= 5) return;
                                      isCulture = newsState;
                                ...
                                ChoiceChip(
                                  ...
                                  onSelected: (newsState) {
                                    setState(() {
                                      if(isSocial) if (_filterRubricId.length >= 5) return;
                                      isSocial = newsState;
                                ...
                                ChoiceChip(
                                  ...
                                  label: Text("Экономика",
                                      style: TextStyle(
                                        color: isEconomics ? Colors.white : Colors.black,
                                          fontSize: 17,
                                          fontFamily: "montserrat",
                                          fontWeight: FontWeight.w600)),
                                  backgroundColor: AppColors.secondary,
                                  ...
                                  onSelected: (newsState) {
                                    setState(() {
                                      if(isEconomics) if (_filterRubricId.length >= 5) return;
                                      isEconomics = newsState;

                                      filterRubrics(isEconomics, 3);
                                    });
                                  },
                                ),
                              ],
  ...
  void sortPopular() {
    ...
    setState(() {
      ...
      if (_listNews.length > 1) {
        ...
        List<News> newsToSort = _listNews.sublist(1); // Список без первого элемента
        newsToSort.sort((news1, news2) => news2.viewsCount.compareTo(news1.viewsCount));
  ...
  void allRubric() {
    ...
    newsController.fetchNewsList().then((listNews) {
      setState(() {
        ...
        // Если новость с day == 1 найдена, добавляем ее первым элементом
        if (firstNews != null) {
    ...
    setState(() {
      ...
      if (!rubric) {
        if (rubricId != null) {
          ...
          _hiddenListNews.addAll(_listNews.where((news) => news.rubricId == rubricId));

          // Удаляем все новости с этой рубрикой, кроме первого элемента
          _listNews.removeWhere((news) => news.rubricId == rubricId && news != firstElement);
        ...
        if (rubricId != null && _filterRubricId.contains(rubricId)) {
          ...
          final newsToAdd = _hiddenListNews.where((news) => news.rubricId == rubricId);
          _listNews.addAll(newsToAdd.where((news) => news != firstElement));

          _hiddenListNews.removeWhere((news) => news.rubricId == rubricId); // Удаляем из скрытых
      ...
      setState(() {
        ...
        if (_filterRubricId.isNotEmpty) {
          for (int rubric in _filterRubricId) {
            _hiddenListNews.addAll(_listNews.where((news) => news.rubricId == rubric));
          ...
          // Обновляем состояние
          setState(() {
            log("New data loaded and filtered");
          });
        }
      });
    }
