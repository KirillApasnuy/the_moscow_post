...
Future<void> _firebaseMessagingBackgroundHandler(RemoteMessage message) async {
  ...
  if (message.notification != null) {
    print("notification");// Используйте Local Notifications для отображения уведомлений
...
void callbackDispatcher() {
  Workmanager().executeTask((task, inputData) async {
    ...
    await firebaseController.sendNotification( // Токен устройства, на которое отправляем
      'Авто-уведомление',
